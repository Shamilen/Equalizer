...
% Last Modified by GUIDE v2.5 18-Mar-2019 22:20:30
...
set(handles.text1, 'String', [int2str(x) ' dB']);
set_param('equalizer/dB Gain','db',int2str(x));
...
x=round(get(hObject,'Value'));
set(handles.text2, 'String', [int2str(x) ' dB']);
set_param('equalizer/dB Gain1','db',int2str(x));
...
x=round(get(hObject,'Value'));
set(handles.text3, 'String', [int2str(x) ' dB']);
set_param('equalizer/dB Gain2','db',int2str(x));
...
x=round(get(hObject,'Value'));
set(handles.text4, 'String', [int2str(x) ' dB']);
set_param('equalizer/dB Gain3','db',int2str(x));
...
x=round(get(hObject,'Value'));
set(handles.text5, 'String', [int2str(x) ' dB']);
set_param('equalizer/dB Gain4','db',int2str(x));
...
x=round(get(hObject,'Value'));
set(handles.text6, 'String', [int2str(x) ' dB']);
set_param('equalizer/dB Gain5','db',int2str(x));
...
x=round(get(hObject,'Value'));
set(handles.text7, 'String', [int2str(x) ' dB']);
set_param('equalizer/dB Gain6','db',int2str(x));
...
x=round(get(hObject,'Value'));
set(handles.text8, 'String', [int2str(x) ' dB']);
set_param('equalizer/dB Gain7','db',int2str(x));
...
if strcmp(x,'Play')
    set_param('equalizer', 'SimulationCommand', 'start');
    set(hObject,'String', 'Stop');
else if strcmp(x,'Stop')
            set_param('equalizer', 'SimulationCommand', 'stop');
...
set_param('equalizer/Gain','Gain',int2str(value));
