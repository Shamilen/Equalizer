...
public class FXMLDocumentController implements Initializable {
    ...
    private void stop() {
        ...
        Slider0.setValue(0.01);
        Slider1.setValue(0.01);
        Slider2.setValue(0.01);
        Slider3.setValue(0.01);
        Slider4.setValue(0.01);
        Slider5.setValue(0.01);
        Slider6.setValue(0.01);
        Slider7.setValue(0.01);

        soundSlider.setValue(0.8);
